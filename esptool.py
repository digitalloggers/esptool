...
def main():
    ...
    parser_write_flash.add_argument('--flash_verbatim', '-fv',  help='Write the binary files as they are without changing embedded flash configuration', action='store_true', default=False)
